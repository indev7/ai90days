...
export async function loadMainTreeForUser(userId, options = {}) {
  ...
  try {
    ...
    // Fetch sharedOKRTs - Only fetch Objectives (type='O'), not KRs
    // KRs will be fetched separately and nested inside their parent Objectives
    ...
    // For each shared objective (type='O'), fetch its comments and KRs
