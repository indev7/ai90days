export const JIRA_INITIATIVE_DOMAIN = `{
  ...
  "mainTreeNote": "Initiatives may be available in mainTree.initiatives. Prefer using mainTree data when present before requesting Jira reads, except for aggregation/counting/summarizing requests.",
  "aggregationException": "If the user asks to count, summarize, aggregate, group by, or rank Initiatives, prefer JQL + Jira API (e.g., countOnly or distinct queries) instead of mainTree to ensure accurate totals.",
  "xJqlGuidance": {
    "rules": [
