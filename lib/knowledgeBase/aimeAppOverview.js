export const AIME_APP_OVERVIEW = `# Aime Web Application Overview
...
- Avatar menu (top-right): quick access to Profile settings, account actions, and sign out.
...
- JIRA (\`/jira\`): login to JIRA and see issue tickets.
- Confluence (\`/confluence\`): connect Confluence for knowledge base search.
