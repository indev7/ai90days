...
// Disable file logging on Vercel (serverless) to prevent memory leaks
const ENABLE_FILE_LOGGING = process.env.ENABLE_LLM_FILE_LOGGING === 'true';
...
export async function logLlmApiInteraction({
  ...
  // Skip file logging on Vercel to prevent memory leaks
