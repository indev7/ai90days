...
async function runMigration() {
  console.log('🚀 Starting vision and mission fields migration...\n');
  ...
  try {
    ...
    try {
      ...
      const migrationPath = join(__dirname, '..', 'Phase1', 'PGDB', 'add-vision-mission-to-groups.sql');
      ...
      if (verifyColumns.rows.length === 2) {
        ...
        console.log('\n✨ Vision and mission fields migration complete!');
      } else {
